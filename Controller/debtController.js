...
exports.payEMI = async (req, res) => {
  ...
  try {
    ...
    const principal = loan.principleAmount; // Principal loan amount
    const annualInterestRate = loan.interest; // Annual interest rate
    const tenureMonths = loan.tenureMonths; // Loan tenure in months
